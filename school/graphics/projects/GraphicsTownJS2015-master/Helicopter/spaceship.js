...
(function () {
        ...
        if (!copterBodyBuffers) {
            var arrays = {
                vpos : { numComponents: 3, data: [
					-1.0,.25,0,     -.75,.25,-.75,    0,.25,-1.0,
					.75,.25,-.75,  1.0,.25,0,         .75,.25,.75,
					0,.25,1.0,      -.75,.25,.75,     0,.5,0,        0,0,0
                ...
                indices : [ 0,1,9,  1,2,9,  2,3,9,  3,4,9,  4,5,9,  5,6,9,  6,7,9,  7,0,9,  //Bottom of saucer
							0,1,8,  1,2,8,  2,3,8,  3,4,8,  4,5,8,  5,6,8,  6,7,8,  7,0,8,  //Top of saucer
				
							//0,1,4, 1,2,4, 2,3,4, 3,0,4, 1,0,5, 2,1,5, 3,2,5, 0,3,5,
                           //6,7,10, 7,8,10, 8,8,10, 8,6,10
                            ]
            };
    ...
    Copter.prototype.draw = function(drawingState) {
		...
		//these two lines are for making the lil guy spin
    ...
    var flyingSpeed = 6/1000;          // units per milli-second
    var turningSpeed = 100/1000;         // radians per milli-second
...
grobjects.push(new Copter());
grobjects.push(new Copter());
grobjects.push(new Helipad([-45,7,-30]));
grobjects.push(new Helipad([30,2,3]));
grobjects.push(new Helipad([-14,4,-25]));
grobjects.push(new Helipad([13,2,37]));
grobjects.push(new Helipad([42,1,4]));
grobjects.push(new Helipad([37,4,-23]));
grobjects.push(new Copter());
grobjects.push(new Copter());
grobjects.push(new Helipad([-26,5,35]));
grobjects.push(new Helipad([42,2,41]));
grobjects.push(new Helipad([-38,3,-22]));
grobjects.push(new Helipad([0,4,-22]));
grobjects.push(new Helipad([38,1,0]));
