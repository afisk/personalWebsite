...
grobjects.push(new SkyScraper("Scraper1",[2,0,-2],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper2",[2,0,1],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper3",[2,0,3],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper4",[2,0,4],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper5",[2,0,4.5],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper6",[-1,0,-2],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper7",[-4,0,-2],0.1, [0,0.5,1]));
grobjects.push(new SkyScraper("Scraper8",[-7,0,-2],0.1, [0,0.5,1]));

grobjects.push(new SkyScraper("Scraper7",[ -5,0,1],0.2, [0,0,1]));
grobjects.push(new SkyScraper("Scraper8",[ -2,0,1],0.2, [0,0,1]));
grobjects.push(new SkyScraper("Scraper8",[ -2,0,4],0.2, [0,0,1]));
grobjects.push(new SkyScraper("Scraper9",[ -8,0,8],0.25, [0,0,1]));
